...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-011-0036-some-questions-question-36-d6472584",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-011-0036-c1b4a96c6573",
        "url": "https://www.unsolvedmath.com/problems/AMR-011-0036"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Let $(G_n)$ and $(H_n)$ converge to the same graph limit, and let $(T_n)$ be a convergent sequence with each $T_n$ a spanning tree of $G_n$. Do there exist spanning trees $P_n$ of $H_n$ converging to the same limit as $(T_n)$?",
      "version": 1
    },
    "title": "Some Questions — Question 36",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "d91cdc3c261819d46e1087b9985f64958a63b64f12a5ead0dc7161408bc5dd21"
}
```
